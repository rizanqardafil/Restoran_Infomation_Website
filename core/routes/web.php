...
Route::group(['prefix' => 'admin', 'middleware' => ['auth:admin', 'checkstatus']], function () {
    ...
    Route::group(['middleware' => 'checkpermission:Product Management'], function () {
        ...
        Route::get('/product/rejected/orders', 'Admin\ProductOrderController@rejected')->name('admin.rejected.product.orders');
         Route::get('/product/grafik/orders', 'Admin\ProductOrderController@grafik')->name('admin.grafik.product.orders');
    ...
    //Tambah Route Statistic
    Route::group(['middleware' => 'checkpermission:Statistic'], function(){
        //Admin Statistic Route
        Route::get('/statistic', 'Admin\ChartController@index')->name('admin.statistic.index');
    });
